defmodule ShareCircle.AccountsTest do
  use ShareCircle.DataCase

  alias ShareCircle.Accounts

  import ShareCircle.AccountsFixtures
  alias ShareCircle.Accounts.{User, UserToken}
  ...
  describe "change_user_email/3" do
    test "returns a user changeset" do
      ...
      assert :display_name in changeset.required
    end
  end
  ...
  describe "update_user_password/2" do
    ...
    test "validates maximum values for password for security", %{user: user} do
      too_long = String.duplicate("db", 129)
